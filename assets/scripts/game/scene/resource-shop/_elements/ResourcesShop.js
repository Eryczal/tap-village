...
class ResourcesShop extends Element {
    ...
    draw() {
        ...
        this.game.strokeText("Zasoby", this.SIZE / 2 + this.MENU_SIZE, this.HEADER_SIZE, this.HEADER_SIZE, "#000", "center", "top");
        this.game.writeText("Zasoby", this.SIZE / 2 + this.MENU_SIZE, this.HEADER_SIZE, this.HEADER_SIZE, "#fff", "center", "top");
