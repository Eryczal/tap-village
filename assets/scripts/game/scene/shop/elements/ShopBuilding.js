...
class ShopBuilding extends Element {
	constructor(game, parent, id, column, row) {
		...
		this.DESCRIPTION_HEIGHT =
			this.game.writeText(this.buildingDescription, this.x + this.size / 2, this.DESCRIPTION_Y - this.scroll, this.TEXT_SIZE, "transparent", "center", "top")
		...
		this.buyButton = new ShopBuyButton(
			game,
